...
public class ecommerce_tc_3 extends base {
	...
	public static void main(String[] args) throws MalformedURLException { // TODO Auto-generated method stub
		...
		String textProductCar = driver.findElement(By.id("com.androidsample.generalstore:id/productName")).getText();
		System.out.println(textProductCar);
		Assert.assertEquals("Nike SFB Jungle", textProductCar);
	}
